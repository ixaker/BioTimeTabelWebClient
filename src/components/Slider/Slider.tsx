            ...
            <div className="slider-container">
                ...
                >
                    ...
                    <svg
                        ...
                        <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M249.38 336 170 256l79.38-80m-68.35 80H342"></path>
                        <path fill="none"
                            strokeMiterlimit="10"
                            strokeWidth="32"
                ...
                >
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512"
                        ...
                        width="4em"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M262.62 336 342 256l-79.38-80m68.35 80H170"></path><path fill="none" strokeMiterlimit="10" strokeWidth="32" d="M256 448c106 0 192-86 192-192S362 64 256 64 64 150 64 256s86 192 192 192z"></path>
                    </svg>
